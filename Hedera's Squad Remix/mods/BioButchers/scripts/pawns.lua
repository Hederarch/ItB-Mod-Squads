...
local a = ANIMS
a.buckler_mech =            a.MechUnit:new{Image = "units/player/buckler_mech.png", PosX = -20, PosY = -6}
a.buckler_mecha =            a.MechUnit:new{Image = "units/player/buckler_mech_a.png", PosX = -21, PosY = -6, NumFrames = 4 }
a.buckler_mechw =            a.MechUnit:new{Image = "units/player/buckler_mech_w.png", PosX = -22, PosY = 9 } --PosX = -19, PosY = 6
a.buckler_mech_broken =        a.MechUnit:new{Image = "units/player/buckler_mech_broken.png", PosX = -20, PosY = -5 }
a.buckler_mechw_broken =    a.MechUnit:new{Image = "units/player/buckler_mech_w_broken.png", PosX = -23, PosY = 6 }
...
a.saw_mech =            a.MechUnit:new{Image = "units/player/saw_mech.png", PosX = -20, PosY = -6}
a.saw_mecha =            a.MechUnit:new{Image = "units/player/saw_mech_a.png", PosX = -21, PosY = -6, NumFrames = 4 }
a.saw_mechw =            a.MechUnit:new{Image = "units/player/saw_mech_w.png", PosX = -23, PosY = 6 }
a.saw_mech_broken =        a.MechUnit:new{Image = "units/player/saw_mech_broken.png", PosX = -23, PosY = -4 } -- 18, 4
...
a.rupture_mechw =            a.MechUnit:new{Image = "units/player/rupture_mech_w.png", PosX = -22, PosY = 2 } 
a.rupture_mech_broken =        a.MechUnit:new{Image = "units/player/rupture_mech_broken.png", PosX = -18, PosY = -7 } -- -23,2; 23,-4
a.rupture_mechw_broken =    a.MechUnit:new{Image = "units/player/rupture_mech_w_broken.png", PosX = -22, PosY = 3 }
